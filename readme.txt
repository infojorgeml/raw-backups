...
= 0.3.2 =
* The RAW Backup screen now states which database the site actually uses (SQLite file vs MySQL/MariaDB host + database name + table prefix), so imported data is never hunted for in the wrong server.
